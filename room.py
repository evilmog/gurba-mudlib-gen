...
if args.area is None:
    # replace the default here with a real domain
    args.area = "replaceme"

#replace me with a real path to the domain in question

syspath = "../gurba/lib/domains/replaceme/rooms/"
...
# this code here is for the co-ordinate system I put into my
# version of gurba, it may not be appropriate for your mud
